'use strict';var vue=require('vue');const dropdownGap = 10;
...
function render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return vue.withDirectives((vue.openBlock(), vue.createElementBlock("div", {
  ...
  }, null, 40, _hoisted_2), [[vue.vModelText, _ctx.inputData]])]), _ctx.open ? (vue.openBlock(), vue.createElementBlock("div", {
    key: 0,
    class: vue.normalizeClass(["venAutocomplete__dropdown", {
  ...
  }, [(vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(_ctx.computedList, (item, ind) => {
    return vue.openBlock(), vue.createElementBlock("div", {
    ...
    }, vue.toDisplayString(item), 43, _hoisted_3);
  }), 128))], 6)) : vue.createCommentVNode("", true)], 2)), [[_directive_outside, _ctx.closeList]]);
